...
- `swift test --package-path FoleyCore` for FoleyCore package changes
- `xcodebuild -project Foley.xcodeproj -scheme Foley -configuration Debug build` for app, share extension, or project integration changes
